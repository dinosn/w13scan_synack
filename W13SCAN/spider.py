...
def init_w13scan():
    ...
    configure = {
        ...
        "disable": [],
        "able": [],
        "excludes": ["google", "microsoft", '.synack.com']  # URLs that are excluded
    }
    init(root, configure)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s',metavar='http(s)://domain', help="Initiate scan on domain")
    parser.add_argument('-f',metavar='domains.txt',help="Read domains from file")
